...
const Task = ({task, list, onEdit, onRemove, onCompleted}) => {
    return (
        <div className="tasks__item" >
            <div className="checkbox">
                <input type="checkbox" onChange={()=>(onCompleted(task))} value={task.completed} defaultChecked={task.completed} id={task.id}
